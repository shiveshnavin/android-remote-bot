...
const PostToYoutube_1 = require("./tasks/PostToYoutube");
...
//@ts-ignore
pipe_tasks_1.VariantConfig[PostToInstagram_1.PostToInstagram.TASK_TYPE_NAME] = [new PostToInstagram_1.PostToInstagram(bot), new PostToYoutube_1.PostToYoutube(bot)];
