...
export declare class AndroidBot {
    ...
    shareVideoByFile(filePath: string, activity?: string, packageName?: string): Promise<void>;
    shareVideoById(mediaId: string, targetActivity?: string, targetPackage?: string): Promise<void>;
