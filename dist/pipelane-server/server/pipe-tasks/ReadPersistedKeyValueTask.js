...
exports.ReadPersistedKeyValueTask = void 0;
const multi_db_orm_1 = require("multi-db-orm");
const pipelane_1 = require("pipelane");
class ReadPersistedKeyValueTask extends pipelane_1.PipeTask {
    static TASK_VARIANT_NAME = "read-persisted-key-value";
    static TASK_TYPE_NAME = "read-persisted";
    db = undefined;
...
exports.ReadPersistedKeyValueTask = ReadPersistedKeyValueTask;
