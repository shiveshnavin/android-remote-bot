...
async function igEnterCaptionAndPost(caption) {
    ...
    let shared = false;
    if (!shared) {
        shareBtn = await bot.waitFor(() => (bot.findElementByAttribute("resource-id", "com.instagram.android:id/share_button", null, true)), 5000, 1000, 'share_button button').catch(e => {
